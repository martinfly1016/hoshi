...
| v0.3.41 | 2026-05-24 22:40 JST | 用户首页 | `/index.html` 命式页表标题 | 将四柱结构表标题从「四柱を横に並べて、要素ごとに確認する」改为更简洁的「八字要素表」 | `/latest.html` / `/index.html?v=20260524-user-chart-title-1` | - | 待提交 |
