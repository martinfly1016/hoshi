...
| v0.3.46 | 2026-05-24 23:15 JST | 用户首页 | `/index.html` 命盤要点动态图标 | 命盤要点解読的日主主题改为按日主天干显示动态图标，例如甲木树木、乙木花草、丙火太阳、丁火灯火、壬水波纹等；其他主题继续使用类别图标 | `/latest.html` / `/index.html?v=20260524-user-key-reading-icons-2` | - | 待提交 |
