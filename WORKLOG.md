...
| v0.3.48 | 2026-05-24 23:40 JST | 用户首页 | `/index.html` 命盤要点人生课题 | 将命盤要点中的通変星主题改为「人生課題」，显示为「食神の課題」等更清楚的用户向表达，并为各通変星补充人生课题说明与读取来源 | `/latest.html` / `/index.html?v=20260524-user-key-reading-content-2` | - | 待提交 |
