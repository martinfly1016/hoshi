...
- 归档约定：产品侧要求后续每次操作都留下修改日志，并在页面大改时保留旧版页面供对比。本次已从 `b365f80` 恢复用户页改造前的 `site3` 快照到 `site3/archive/pre-usercalc-20260514/`，发布后可通过 `/archive/pre-usercalc-20260514/index.html` 对比旧版首页。
