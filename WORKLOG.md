...
| v0.3.40 | 2026-05-24 22:35 JST | 用户首页 | `/index.html` 命式页四柱表头 | 删除「検証ページの詳細表と同じ読み方で…」说明文，并将四柱结构表头改为单列，减少无效文字和占位空白 | `/latest.html` / `/index.html?v=20260524-user-chart-desktop-3` | - | 待提交 |
