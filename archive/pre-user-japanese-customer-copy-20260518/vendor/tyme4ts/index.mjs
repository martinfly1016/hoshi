...
class SolarWeek extends WeekUnit {
  ...
  getIndexInYear() {
    ...
    let w = SolarWeek.fromYm(this.getYear(), 1, 0, this.getStart());
...
class SolarDay extends DayUnit {
  ...
  getSolarWeek(start) {
    const y = this.getYear();
    const m = this.getMonth();
    return SolarWeek.fromYm(y, m, Math.ceil((this.getDay() + SolarDay.fromYmd(y, m, 1).getWeek().next(-start).getIndex()) / 7) - 1, start);
  }
  getPhenologyDay() {
...
class SolarFestival extends AbstractFestival {
  ...
  static fromIndex(year, index) {
    ...
    return new SolarFestival(0 /* DAY */, i, e, SolarDay.fromYmd(y, e.getValue(2), e.getValue(3)));
  }
  static fromYmd(year, month, day) {
    ...
    for (let i = 0, j = SolarFestival.NAMES.length; i < j; i++) {
      ...
      if (d.getYear() >= e.getStartYear() && d.getMonth() === e.getValue(2) && d.getDay() === e.getValue(3)) {
        return new SolarFestival(0 /* DAY */, i, e, d);
      }
    }
    return null;
  }
  ...
  static fromIndex(year, index) {
    ...
    switch (e.getType()) {
      case 2 /* LUNAR_DAY */:
        ...
        return new LunarFestival(0 /* DAY */, i, e, offset === 0 ? d : d.next(offset));
      case 3 /* TERM_DAY */:
        return new LunarFestival(1 /* TERM */, i, e, SolarTerm.fromIndex(y, e.getValue(2)).getSolarDay().getLunarDay());
    }
    return null;
  }
  static fromYmd(year, month, day) {
      ...
      switch (e.getType()) {
        case 2 /* LUNAR_DAY */:
          ...
          if (0 === offset) {
            if (d.getMonth() === e.getValue(2) && d.getDay() === e.getValue(3)) {
              return new LunarFestival(0 /* DAY */, i, e, d);
            }
          } else {
        ...
        case 3 /* TERM_DAY */:
          ...
          if (term.getDayIndex() === 0 && term.getSolarTerm().getIndex() === e.getValue(2) % 24) {
            return new LunarFestival(1 /* TERM */, i, e, d);
          }
      }
    }
    return null;
