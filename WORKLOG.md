...
| v0.3.42 | 2026-05-24 22:48 JST | 用户首页 | `/index.html` 命盤要点区 | 将「命式タグ索引」改为「命盤要点解読」，说明文从标签索引语气改为要点解读语气；左侧导航第三项同步从「タグ索引」改为「要点解読」 | `/latest.html` / `/index.html?v=20260524-user-key-reading-1` | - | 待提交 |
