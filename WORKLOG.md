...
| v0.3.45 | 2026-05-24 23:08 JST | 用户首页 | `/index.html` 命盤要点图标列表 | 将命盤要点解読主题卡升级为带图标的解读列表：每项左侧显示圆形主题图标，中间为标签/说明/依据，右侧保留「詳細説明」按钮；手机端自动换行为两列结构 | `/latest.html` / `/index.html?v=20260524-user-key-reading-icons-1` | - | 待提交 |
