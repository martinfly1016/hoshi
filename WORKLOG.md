...
| v0.3.50 | 2026-05-24 23:58 JST | 用户首页 | `/index.html` 命盤要点事业财运 | 在命盤要点解読中新增「仕事運」和「金運」主题；事业运结合月柱、命式型、身强弱和通変星解释，金运结合正財/偏財、五行平衡和用神解释 | `/latest.html` / `/index.html?v=20260524-user-key-reading-content-4` | - | 待提交 |
