...
| v0.3.53 | 2026-05-25 00:25 JST | 用户首页 | `/index.html` 大運・流年占位页 | 在大運・流年详解页完成前，先改为稳定的「開発中」说明页，并提供「現在の命式へ戻る」和「入力内容を修正する」入口，避免用户误入后无法返回 | `/latest.html` / `/index.html?v=20260525-user-fortune-placeholder-1` | - | 待提交 |
