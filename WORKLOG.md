...
| v0.2.3 | 2026-05-15 00:15 JST | 用户首页 | 首页结果区 `/index.html` | 在用户页加入大运、流年初版计算展示与解说；未选性别时提示大运需性别，流年直接展示今年起的年度干支主题 | `/index.html?v=20260515-luck-reading-1` | `/archive/pre-user-luck-reading-20260515/index.html?v=20260515-pre-luck-reading-1` | 本次发布 |
