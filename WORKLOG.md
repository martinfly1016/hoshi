...
| v0.3.47 | 2026-05-24 23:28 JST | 用户首页 | `/index.html` 命盤要点标签内容 | 从用户视角重组命盤要点标签：将日主改为「命主タイプ」、命格与身强弱合并为「人生格局と特質」、强弱/补缺/用神合并为「五行特質」，让标签说明从算法字段转为人物特质解读入口 | `/latest.html` / `/index.html?v=20260524-user-key-reading-content-1` | - | 待提交 |
